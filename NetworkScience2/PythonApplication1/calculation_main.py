...
S2 = { "Steve Carell" : "Jason Segel","Jonah Hill" : "Channing Tatum"}

S3 = {  "Steve Carell" : "Jason Segel", "Jonah Hill" : "Channing Tatum", \
        "Elijah Wood" : "Rainn Wilson"}

S4 = { "Jack Black" : "Bryan Cranston", "Keanu Reeves":"Micahel Nyqvist", \
        "Steve Carell" : "Jason Segel", "Johnny Depp" : "Javier Bardem"}

S5 = { "Jack Black" : "Bryan Cranston", "Jake Johnson":"Hailee Steinfield", "Keanu Reeves":"Micahel Nyqvist", \
        "Steve Carell" : "Jason Segel", "Johnny Depp" : "Javier Bardem"}
...
s2_time = totalTime/100
print("Avg Time taken for |S|=2: ", s2_time, "seconds")
...
for x in range(100):
    ...
    time_taken = time.process_time() - start
    totalTime += time_taken
s3_time = totalTime/100

print("Avg Time taken for |S|=3: ", s3_time, "seconds")
...
for x in range(100):
    ...
    time_taken = time.process_time() - start
    totalTime += time_taken
s4_time = totalTime/100

print("Avg Time taken for |S|=4: ", s4_time, "seconds")
...
for x in range(100):
    ...
    time_taken = time.process_time() - start
    totalTime += time_taken
s5_time = totalTime/100

print("Avg Time taken for |S|=5: ", s5_time, "seconds")
